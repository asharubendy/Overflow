...
public GameObject ShopSelling;
int mouseWheelPos;
int i = 0;
 public void Awake() {
   //setting where to get the sprites from
    ItemSpritesContainer = GameObject.Find("CharController/ItemAssetsContainer");
    ShopSelling = GameObject.Find("GameUI Canvas/PlayerInventory/Inventory3/InventorySlot/ShopSelling");
   ...
   //setting boolean array size 
    ...
    SlotArray[0]= GameObject.Find("GameUI Canvas/PlayerInventory/Inventory3/InventorySlot/ShopInventory");
    SlotArray[1]= GameObject.Find("GameUI Canvas/PlayerInventory/Inventory3/InventorySlot/ShopInventoryP2");
    SlotArray[2]= GameObject.Find("GameUI Canvas/PlayerInventory/Inventory3/InventorySlot/ShopInventoryP3");
...
//sets the instance of the inventory
  ...
  public void SyncShop(){
    ...
    ShopSelling.GetComponent<Image>().color = new Color (255,255,255,0);
